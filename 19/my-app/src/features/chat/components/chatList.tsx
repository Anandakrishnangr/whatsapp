...
<div className='flex-grow overflow-y-scroll  scrollbar-thin scrollbar-track-private-secondary scrollbar-thumb-private-primary'>
    {chatList.map((element) => {
        return <div className='flex p-3 hover:bg-private-primaryHover border-b border-private-primary-transparent/30 hover:border-private-primary-transparent/10 cursor-pointer'>
